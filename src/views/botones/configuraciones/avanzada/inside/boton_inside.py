...
class Boton_inside(Funcion_inside, Boton_agregar, Boton_eliminar, Boton_capacidad):
    def boton_inside_agregar(self, widget):
        ...
        self.inside_agregar.setIcon(QIcon('src/views/static/icons/icono_capacidad'))  # icono
    ...
    def boton_inside_eliminar(self, widget):
        ...
        self.inside_eliminar.setIcon(QIcon('src/views/static/icons/icono_capacidad'))  # icono
    ...
    def boton_inside_cambiar(self, widget):
        ...
        self.inside_cambiar.setIcon(QIcon('src/views/static/icons/icono_capacidad'))  # icono
