...
class BotonEstudiantes(FuncionesEstudiantes):
    ...
    def textosEstado(self, widget):
        ...
        self.texto_informativo.setGeometry((self.width / 4.2), (self.height / 1.5),
        ...
        self.texto_temporal.setGeometry((self.width / 4.2), (self.height / 1.5),
                                        self.width / 1.8, self.height / 3)
    ...
    def giftEstudiantes(self, widget):
        ...
        self.giflabel.setGeometry((self.width / 2.5), (self.height / 4),
